...
/// <summary>
/// player two implementation of the archer skills controller main class. Bind player two specific control bindings to the
/// archer skills controller main functionality
/// </summary>
public class ArcherSkillsControllerTwo : ArcherSkillsControllerMain {
